...
> 目标：总结微调经验，轻量预习多模态，环境准备。

---

## Task 107：项目7 完整复盘

**产出物**：`docs/notes/project7-retrospective.md`（项目复盘报告）

- [ ] 95.1 回顾项目 7 全部目标，逐项检查完成情况：SFT、RLHF、评估、部署（20min）
- [ ] 95.2 整理关键数据汇总表：各实验的 loss、显存占用、BLEU/ROUGE 分数、推理延迟（20min）
- [ ] 95.3 撰写 500 字复盘：最大 3 个收获、最深 2 个教训、如果重来会怎么做的 1 个改变（20min）
